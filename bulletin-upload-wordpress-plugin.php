...
define('CBP_VERSION', '0.4.0-test51');
...
require_once CBP_DIR . 'includes/class-cbp-schedule-v12.php';
require_once CBP_DIR . 'includes/class-cbp-schedule-v13.php';
require_once CBP_DIR . 'includes/class-cbp-schedule-v14.php';
require_once CBP_DIR . 'includes/class-cbp-schedule-v15.php';
require_once CBP_DIR . 'includes/class-cbp-schedule-v16.php';
require_once CBP_DIR . 'includes/class-cbp-schedule-v17.php';
require_once CBP_DIR . 'includes/class-cbp-schedule-v18.php';
require_once CBP_DIR . 'includes/class-cbp-schedule-v19.php';
...
require_once CBP_DIR . 'includes/class-cbp-schedule-v24.php';
require_once CBP_DIR . 'includes/class-cbp-schedule-v25.php';
require_once CBP_DIR . 'includes/class-cbp-schedule-v26.php';
require_once CBP_DIR . 'includes/class-cbp-schedule-v27.php';
require_once CBP_DIR . 'includes/class-cbp-schedule-v28.php';
require_once CBP_DIR . 'includes/class-cbp-schedule-v29.php';
require_once CBP_DIR . 'includes/class-cbp-schedule-v30.php';
...
CBP_Schedule_V12::instance();
CBP_Schedule_V13::instance();
CBP_Schedule_V14::instance();
CBP_Schedule_V15::instance();
CBP_Schedule_V16::instance();
CBP_Schedule_V17::instance();
CBP_Schedule_V18::instance();
CBP_Schedule_V19::instance();
CBP_Schedule_V20::instance();
CBP_Schedule_V21::instance();
CBP_Schedule_V22::instance();
CBP_Schedule_V23::instance();
CBP_Schedule_V24::instance();
CBP_Schedule_V25::instance();
CBP_Schedule_V26::instance();
CBP_Schedule_V27::instance();
CBP_Schedule_V28::instance();
CBP_Schedule_V29::instance();
CBP_Schedule_V30::instance();
