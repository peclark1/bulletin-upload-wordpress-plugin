...
This repository also contains the separately installable **Parish Forms** companion plugin. It does not change the Bulletin Publisher package. See [`parish-forms/README.md`](parish-forms/README.md), or run `make parish-forms` to build its WordPress installation ZIP.
